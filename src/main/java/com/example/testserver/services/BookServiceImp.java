...
import com.example.testserver.exceptions.BookNotFoundException;
import com.example.testserver.models.Book;
import com.example.testserver.repositories.BookRepository;
...
public class BookServiceImp  implements IBookService {
    ...
    public Set<Book> findByAuthor(String author) {
        return bookRepository.findBooksByAuthorContaining(author);
    }
